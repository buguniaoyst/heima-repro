    ...
    layui.use(['laypage', 'layer','laydate','jquery','form'],function() {
        ...
        var thisDate = function (curr) {
           ...
           /*      if(data[i].testStatus == "开启"){
                ...
                td4 = $("<td align='center' >  <button class='layui-btn layui-btn-radius'  >"+ data[i].score+"</button></td>");
                testName = JSON.stringify(testName);
                var td5 = $("<td align='center'><button class='layui-btn layui-btn-radius'  onclick='showScoreDetail("+testId+","+data[i].userId+","+testName+")'>查看详情</button></td>");
                td1.appendTo(tr);
                td2.appendTo(tr);
                td3.appendTo(tr);
                td4.appendTo(tr);
